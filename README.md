...
這個 DB layer 是額外提供的本機資料匯入路徑，會把既有 `data/raw/` 與 `data/processed/` artifact 寫入 PostgreSQL，方便後續做長期趨勢分析、weekly summary、fatigue tracking、feature engineering versioning 與 AI report evaluation。
