---
name: reviewer
description: Codex adapter for the shared reviewer workflow. Use the shared reviewer instructions for review scope, style, and output format.
---

# Codex Adapter: Code Reviewer
