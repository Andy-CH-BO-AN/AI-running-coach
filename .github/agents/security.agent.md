---
name: security
description: GitHub Copilot adapter for shared security review. Use the shared security instructions for secret scanning, config safety, DB safety, and API risk checks.
---

# GitHub Adapter: Security Reviewer
