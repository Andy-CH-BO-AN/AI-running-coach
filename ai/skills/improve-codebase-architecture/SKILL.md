...
Then walk the codebase using your runtime's available subagent or task delegation tool (e.g. `Agent` tool with `subagent_type=Explore`, `spawn_agent`, or equivalent subagent primitive). If your runtime environment does not support subagent spawning, perform the exploration step sequentially within the current agent turn. Don't follow rigid heuristics — explore organically and note where you experience friction:
